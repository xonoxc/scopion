const MetricRow = ({
  ...
  return (
    <div className="flex items-center justify-between group py-3 border-b border-white/5 last:border-0 hover:bg-white/2 px-2 rounded -mx-2 transition-colors">
      <span className="text-sm text-gray-400 font-medium w-32">{label}</span>

      {/* Dotted Line */}
      <div className="flex-1 mx-4 border-b-2 border-dotted border-gray-800 relative top-px"></div>
...
export const VariantMonitor = () => {
  return (
    <div
      className="bg-card glass-panel rounded-2xl border border-white/10 p-1 mb-12 animate-fade-in-up"
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-1.5 rounded text-xs font-bold text-gray-400 border border-white/10 hover:text-white hover:border-white/20 transition-colors">
            EDIT
          </button>
          <button className="px-4 py-1.5 rounded text-xs font-bold text-white bg-white/10 border border-white/10 hover:bg-white/20 transition-colors">
            LAUNCH
          </button>
        </div>
      </div>
      ...
      <div className="bg-page/50 rounded-xl border border-white/5 m-1 p-6 grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          <div className="flex items-center justify-between mb-8">
            ...
            <button className="text-[10px] font-bold text-gray-400 border border-white/10 px-3 py-1 rounded hover:text-white hover:border-white/20 transition-all">
              VIEW
            </button>
          </div>
        ...
        <div className="relative">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex gap-4 text-[10px] font-bold text-gray-500">
              ...
              <button className="text-white border-b-2 border-white pb-0.5">
                7D
              </button>
          ...
          <div className="h-48 w-full relative">
            ...
            >
              ...
              <circle
                ...
                cy="80"
                r="4"
                className="fill-page stroke-emerald-500 stroke-2"
              />
              <circle
                cx="280"
                cy="100"
          ...
          <div className="grid grid-cols-2 gap-8 mt-6 pt-6 border-t border-white/5">
            <StatSmall
              ...
              value={<span className="text-emerald-400">3</span>}
            />
